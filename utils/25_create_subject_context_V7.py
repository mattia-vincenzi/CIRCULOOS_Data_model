...
def open_json(fileUrl):
    ...
    if fileUrl[0:4] == "http":
        ...
        try:
            ...
            print("Error loading url:"+fileUrl)
            return None
        ...
        try:
            ...
            print("Error loading file :"+fileUrl)
            return None
...
#             # WILL HAVE ERROR!!!!
#             contextDict["@context"][str(item)] =customRepository+ str(item) + termType
#         else:    
        ...
        for prop in modelYamlDict:
            ...
            if isinstance(modelYamlDict[prop], dict):
                ...
                if isinstance(modelYamlDict, dict) and ("type" in propKeys or "description" in propKeys) and prop != "x-ngsi":
                    ...
                    if 'customRepository' in globals():
                         print("setting :"+prop)
                         contextDict["@context"][str(prop)] = customRepository + "schema.json#/" + str(prop)
                    else:
...
# / debug  
        ...
        if 'customRepository' in globals():
            contextDict["@context"][dataModel] = customRepository
        else:
        ...
        # print("_____________________________________________________________________________________________________________________________________________________________________________")
        # print("commonContextDict[@context]")
        # print(commonContextDict["@context"])
        ...
        # if 'customRepository' in globals():
        #     urlCustomContext=customRepository+"notes_context.jsonld"
        # else:
...
if 'customRepository' in globals():
    print("filepath "+fileTargetPath)
    print("contentVariable:"+contentVariable)
    with open(fileTargetPath, 'w') as file:
        file.write(contentVariable)
else:
